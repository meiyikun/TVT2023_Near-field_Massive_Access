%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% AER performance vs Number of High-resolution ADCs
% Only TS-OAMP
% 2 bits quantization
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
var_set = [1,2];
Nsim = ones(1,length(var_set))*5000;
method = char('TS-OAMP');
...
var_set3 = [0:7];
figure
p1=semilogy(var_set3,Perform.AER(:,1),'k-<','MarkerFaceColor',[0 0 0],'MarkerSize',MarkerSize,'LineWidth',LineWidth);grid on;hold on;
p2=semilogy(var_set3,Perform.AER(:,2),'g-*','MarkerFaceColor',[0 0 0],'MarkerSize',MarkerSize,'LineWidth',LineWidth);grid on;hold on;
set(gca,'xtick',var_set3,'xticklabel',var_set2,'FontSize',Fontsize);
gcf_set = [p1, p2];
legend(gcf_set,{'$M = 56, P_t = -10$ dBm','$M = 48, P_t = 5$ dBm'},'interpreter','latex');  
xlabel('Number of high-resolution ADCs $|{\cal H}|_c$','Fontsize',Fontsize,'interpreter','latex');
ylabel('AER','Fontsize',Fontsize,'interpreter','latex');
