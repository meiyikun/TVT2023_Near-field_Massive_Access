%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% AER performance vs length of pilot sequence M
...
alg_set = [1:4];
var_set = [48:2:58];
epsilon_set = [0.04, 0.025, 0.03, 0.035, 0.035, 0.037];                     % for SWOMP
Nsim = [1000,1000,2000,2000,3000,3000]*5;                                   % number of simulations
...
for i_var=1:length(var_set)
    ...
    for i_sim = 1:Nsim(i_var)
        ...
        for alg_sel_ii = 1:length(alg_set)
            ...
            %% display
            if mod(i_sim,min(10,Nsim(i_var))) == 0
...
gcf_set = [p1,p2,p3,p4];
legend(gcf_set,{'SWOMP','OAMP-MMV','SS-GAMP','TS-OAMP'},'interpreter','latex');
