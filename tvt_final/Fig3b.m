...
alg_set = [1:4];
var_set = [-10:5:10];                                                       % variables set
epsilon_set = [0.1, 0.07, 0.05, 0.04, 0.034];                               % for SWOMP
Nsim = [1000, 1000, 2000, 2000, 3000]*5;                                      % number of simulations
...
% save AERvsPower_Bit2.mat Perform;
%% Plot
var_set = [-10:5:10];
MarkerSize = 6;
LineWidth = 2;
Fontsize = 15;
p3=semilogy(var_set,Perform.AER(1,:),'k-<','MarkerFaceColor',[0 0 0],'MarkerSize',MarkerSize,'LineWidth',LineWidth);grid on;hold on;
p2=semilogy(var_set,Perform.AER(2,:),'g-*','MarkerFaceColor',[0 0 0],'MarkerSize',MarkerSize,'LineWidth',LineWidth);grid on;hold on;
p4=semilogy(var_set,Perform.AER(3,:),'b-s','MarkerFaceColor',[0 0 0],'MarkerSize',MarkerSize,'LineWidth',LineWidth);grid on;hold on;
p1=semilogy(var_set,Perform.AER(4,:),'m-d','MarkerFaceColor',[0 0 0],'MarkerSize',MarkerSize,'LineWidth',LineWidth);grid on;hold on;
set(gca,'FontSize',Fontsize);
gcf_set = [p1,p2,p3,p4];
legend(gcf_set,{'SWOMP','SS-GAMP','OAMP-MMV','TS-OAMP'},'interpreter','latex');
xlabel('Transimitted power $P_{t}$ (dBm)','Fontsize',Fontsize,'interpreter','latex');
